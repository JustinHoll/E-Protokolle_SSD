$('#absendenBtn').click(function() {
    ...
    var dat1 = $("#dat").val();
    //alert("Datum: " + dat);
    var dat = "" + dat1.substr(8,2) + "." + dat1.substr(5,2) + "." + dat1.substr(0,4);
    var zeit = $("#zeit").val();
    var place = $("#place").val();
    ...
    if ($("input[name=zustand]:checked").val() != "") {
        var erg = $("input[name=zustand]:checked").val();
    }
