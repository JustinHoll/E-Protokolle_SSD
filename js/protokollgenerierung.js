$('#absendenBtn').click(function() {
    ...
    var blut1 = $("#puls1").text();
    var blut2 = $("#puls2").text();
    var blut3 = $("#puls3").text();
    var blut4 = $("#puls4").text();
    var blut5 = $("#puls5").text();
